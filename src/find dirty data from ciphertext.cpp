...
#define KEY_LEN_BIT 256
#define SIGMA_LEN_BIT 128
#define ROW 1739 // 70000 for dataset1, 17396 for dataset2
...
int datasset1_cleaning(){
    ...
    start_time = clock();
    string filename = "/home/husen/vscode/soci-main/dataset/CD_data.csv"; ///home/husen/vscode/soci-main/
    ...
    start_time = clock();
    Error_index error_index_vector =  data_cleaning(ciphertext_vector, ciphertext_range, cp, csp);
    end_time = clock();
...
int datasset2_cleaning(){
    ...
    start_time = clock();
    string filename = "/home/husen/vscode/soci-main/dataset/GeoLife_data.csv"; ///home/husen/vscode/soci-main/
    vector<vector<int>> data = readdata(filename);
    end_time = clock();
    printf("read data time is  ------  %f s\n", ((double)(end_time - start_time)) / 1  / CLOCKS_PER_SEC);
    ...
    start_time = clock();
    Error_index error_index_vector =  data_cleaning2(ciphertext_dv, ciphertext_range, cp, csp);
    end_time = clock();
    printf("data cleaning time is  ------  %f s\n", ((double)(end_time - start_time)) / 1  / CLOCKS_PER_SEC);
